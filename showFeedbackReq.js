        ...
        for (const box1 in loadFeedback[box]) {
          ...
          for (const box2 in loadFeedback[box][box1]) {
            ...
            if (box2 == "correct") {
              ...
              console.log(box, box1, box2, requirementProperty);
              if (box2 === "description") {
                list.style.flexGrow = 1;
                list.innerText = serial + ". ";
                list.innerText +=
                  requirementProperty.length > 55
                    ? requirementProperty.slice(0, 55) + "..."
                    : requirementProperty;
                serial++;
              } else if (isSub) {
                subReqBox.innerHTML += `
                <div class="ps-3 pl-3 d-flex">
                  <div class="flex-grow-1">${
                    requirementProperty.description
                  }</div>
                  ...
                  data-checkbox=${`correct-btn_${box}_${box1}_${box2}`} 
                  ${
                    requirementProperty.correct ? `checked` : ``
                  }> <span class="me-3 mr-3">correct: ${
                  requirementProperty.correct
                }</span> </div>
...
//               } else if (isSub) {
//                 subReqBox.innerHTML += `
//                 <div class="ps-3 pl-3 d-flex my-1">
//                   <div class="flex-grow-1 my-1">${
//                     requirementProperty.description.length > 50
//                       ? requirementProperty.description.slice(0, 50) + "..."
//                       : requirementProperty.description
//                   }</div>
